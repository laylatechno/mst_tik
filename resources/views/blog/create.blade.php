                        ...
                        <form method="POST" action="{{ route('blogs.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date" name="posting_date" class="form-control" id="posting_date" value="<?php echo date('Y-m-d'); ?>" required>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="writer">Penulis <span class="text-danger">*</span></label>
                                    <input type="text" name="writer" class="form-control" id="writer" value="{{ old('writer') }}" required>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="resume">Rangkuman </label>
                                    <input type="text" name="resume" class="form-control" id="resume" value="{{ old('resume') }}">
                                </div>
