                            ...
                            <div class="row">
                                <div class="col-lg-12 margin-tb">
                                    ...
                                    <div class="pull-right">
                                        <a class="btn btn-success mb-2" href="{{ route('categories.create') }}"><i class="fa fa-plus"></i> Tambah Data</a>
                                    </div>
                                    @endcan
                                </div>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @can('category-edit')
                                            <a class="btn btn-primary btn-sm" href="{{ route('categories.edit', $p->id) }}"><i class="fa fa-edit"></i> Edit</a>
                                            @endcan
                                            @can('category-delete')
                                            <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete({{ $p->id }})"><i class="fa fa-trash"></i> Delete</button>
                                            <form id="delete-form-{{ $p->id }}" method="POST" action="{{ route('categories.destroy', $p->id) }}" style="display:none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                            @endcan
