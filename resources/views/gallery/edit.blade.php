                ...
                <div class="col-9">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a class="text-muted text-decoration-none" href="{{ route('customers.index') }}">Halaman Galeri</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            ...
                            <form method="POST" action="{{ route('galleries.update', $data_galleries->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control" id="name" value="{{ $data_galleries->name }}" required>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="link">Link</label>
                                        <input type="text" name="link" class="form-control" id="link" value="{{ $data_galleries->link }}">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="description">Deskripsi</label>
                                        <textarea class="form-control" name="description" id="description">{{ $data_galleries->description }}</textarea>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="position">Urutan</label>
                                        <input type="number" name="position" class="form-control" id="position" value="{{ $data_galleries->position }}">
                                    </div>
                                    <div class="form-group mb-3">
