                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">
                                    <a class="text-muted text-decoration-none" href="{{ route('letters.index') }}">Halaman
                                        Aset</a>
                                </li>
                                ...
                                <div class="row">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="type" id="type" class="form-control" required>
                                            ...
                                            <option value="Undangan" {{ old('type') == 'Undangan' ? 'selected' : '' }}>
                                                Undangan</option>
                                            <option value="Undangan Pemerintahan"
                                                {{ old('type') == 'Undangan Pemerintahan' ? 'selected' : '' }}>Undangan
                                                Pemerintahan</option>
                                            <option value="Undangan Komunitas"
                                                {{ old('type') == 'Undangan Komunitas' ? 'selected' : '' }}>Undangan
                                                Komunitas</option>
                                            <option value="Peminjaman barang"
                                                {{ old('type') == 'Peminjaman barang' ? 'selected' : '' }}>Peminjaman
                                                barang</option>
                                            <option value="Peminjaman Tempat"
                                                {{ old('type') == 'Peminjaman Tempat' ? 'selected' : '' }}>Peminjaman
                                                Tempat</option>
                                            <option value="Pemberitahuan/informasi"
                                                {{ old('type') == 'Pemberitahuan/informasi' ? 'selected' : '' }}>
                                                Pemberitahuan/informasi</option>
                                            <option value="Surat Keterangan"
                                                {{ old('type') == 'Surat Keterangan' ? 'selected' : '' }}>Surat Keterangan
                                            </option>
                                            <option value="Surat Pengajuan"
                                                {{ old('type') == 'Surat Pengajuan' ? 'selected' : '' }}>Surat Pengajuan
                                            </option>
                                            <option value="Surat Permohonan"
                                                {{ old('type') == 'Surat Permohonan' ? 'selected' : '' }}>Surat Permohonan
                                            </option>
                                            <option value="Surat Kuasa"
                                                {{ old('type') == 'Surat Kuasa' ? 'selected' : '' }}>Surat Kuasa</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="letter_number" class="form-control" id="letter_number"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="category" id="category" class="form-control" required>
                                            ...
                                            <option value="incoming" {{ old('category') == 'incoming' ? 'selected' : '' }}>
                                                Surat Masuk</option>
                                            <option value="outgoing" {{ old('category') == 'outgoing' ? 'selected' : '' }}>
                                                Surat Keluar</option>
                                        </select>
                                    </div>
                                        ...
                                        <select name="sender_id" id="sender_id" class="form-control select2">
                                            ...
                                            @foreach ($users as $user)
                                                <option value="{{ $user->id }}"
                                                    {{ old('sender_id') == $user->id ? 'selected' : '' }}>
                                                    {{ $user->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="status" id="status" class="form-control" required>
                                            ...
                                            <option value="sent" {{ old('status') == 'sent' ? 'selected' : '' }}>Sent
                                            </option>
                                        </select>
                                    </div>
