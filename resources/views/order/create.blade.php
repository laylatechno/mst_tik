        ...
        <div class="card-body">
            ...
            <div class="card mb-1" id="tutorial-section">
                ...
                <div class="card-body">
                    ...
                    <ol>
                        <li>
                            Tentukan status transaksi, jika akan melakukan pesanan penjualan maka pilih status transaksi
                            Pesanan Penjualan, lalu jika sudah terjadi penjualan kepada pelanggan, maka sesuaikan/edit
                            dengan item penjualan yang real.
                        </li>
                        <li>
                            Untuk transaksi penjualan yang <b>sudah diterima barang oleh pelanggan dan sudah diselesaikan
                                pembayaran</b>, maka pilih status transaksi Lunas.
                        </li>
                        <li>
                            Sisa transaksi diluar Pesanan Penjualan dan Lunas silahkan pilih antara <b>Belum Lunas dan
                                Pending</b>
                        </li>
                        <li>
                            Jika Status Transaksi <b>Lunas</b>, maka Pelanggan, Kas dan Jenis Pembayaran <b>Wajib Diisi</b>
                            sehingga transaksi tersebut akan mengurangi Kas serta menambah Kuantiti Produk yang dipilih
                        </li>
                        <li>
                            Pilih <b>Pelanggan</b> dari dropdown yang tersedia untuk menentukan kepada siapa barang dijual.
                            Form ini memungkinkan Anda memilih pelanggan yang sudah terdaftar. Pilih pelanggan yang relevan
                            atau tambahkan pelanggan baru jika diperlukan. Untuk Pelanggan yang sifatnya tentatif bisa
                            memilih <b>Pelanggan Umum</b>
                        </li>
                        <li>
                            Cari dan pilih <b>Produk</b> yang ingin dijual, lalu masukkan jumlah (Qty). Pilih produk dari
                            daftar yang telah tersedia dan tentukan jumlah barang yang ingin dijual. Pastikan jumlah yang
                            dimasukkan sesuai dengan stok yang ada.
                        </li>
                        <li>
                            Untuk Pencarian Produk bisa menggunakan beberapa cara, yaitu <b>Barcode</b> (Kursor harus berada
                            pada inputan Barcode), <b>Item Produk</b> Pada list yang terdapat Gambar dan juga mencari produk
                            melalui <b>Dropdown Produk</b>.
                        </li>
                        <li>
                            Untuk <b>Potongan Diskon</b> bisa menggunakan persentase % dan juga diskon jumlah (nilai)
                        </li>
                        <li>
                            Pilih metode <b>Jenis Pembayaran</b>, apakah <b>TUNAI</b> atau <b>TRANSFER</b>. Pilih metode
                            pembayaran yang digunakan oleh pelanggan. Jika pelanggan memilih pembayaran dengan tunai, pilih
                            "TUNAI". Jika menggunakan transfer, pilih "TRANSFER".
                        </li>
                        <li>
                            Jika pembayaran dilakukan dengan <b>TRANSFER</b>, unggah bukti pembayaran dengan memilih file
                            gambar di bagian <b>Gambar</b>. Jika pembayaran menggunakan transfer, Anda perlu mengunggah
                            bukti pembayaran dalam bentuk gambar (misalnya screenshot transfer). Pilih file gambar yang
                            sesuai dari perangkat Anda <b>(Opsional)</b>.
                        </li>
                        <li>
                            Setelah semua informasi lengkap, klik tombol <b>Simpan</b> untuk menyimpan data penjualan.
                            Setelah memastikan semua data sudah terisi dengan benar, klik tombol "Simpan" untuk menyimpan
                            transaksi penjualan Anda.
                        </li>
                    </ol>
                    <p class="text-muted">
                        Pastikan semua informasi telah diisi dengan benar sebelum menyimpan transaksi. Untuk membatalkan,
                        Anda dapat menekan tombol <b>Kembali</b>.
                    </p>
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    <input style="background-color: yellow;" type="text" class="form-control"
                                        id="barcode" name="barcode" placeholder="Scan barcode produk" autofocus>
                                </div>
                            </div>

                            <hr>

                            <form id="form-order" action="{{ route('orders.store') }}" method="post"
                                ...
                                <h5 class="card-title mb-0"><b style="color: blue;">Kode Penjualan :
                                        <input type="hidden" id="no_order" name="no_order"
                                            value="{{ $no_order }}">{{ $no_order }}</input></b></h5>
                                <hr>
                                <div class="form-group mb-3 col-md-6">
                                    <label for="status" class="mb-2">Status Transaksi :</label><br>
                                    <label style="margin-right: 6px;"
                                        title="Pesanan Penjualan: Transaksi ini sedang dalam tahap pesanan awal untuk penjualan. Barang atau jasa telah dipesan oleh pelanggan, tetapi pembayaran belum sepenuhnya dilakukan. (Pintasan: Alt+P)">
                                        <input type="radio" name="status" value="Pesanan Penjualan" id="status-pesanan"
                                            checked>
                                        Pesanan Penjualan <b>(Alt+P)</b>
                                    </label>
                                    <label style="margin-right: 6px;"
                                        title="Lunas: Semua pembayaran terkait transaksi ini telah diselesaikan. Tidak ada saldo atau kewajiban yang tersisa. (Pintasan: Alt+L)">
                                        <input type="radio" name="status" value="Lunas" id="status-lunas">
                                        Lunas <b>(Alt+L)</b>
                                    </label>
                                    <label style="margin-right: 6px;"
                                        title="Belum Lunas: Sebagian pembayaran telah dilakukan, tetapi masih ada sisa yang harus dilunasi. (Pintasan: Alt+B)">
                                        <input type="radio" name="status" value="Belum Lunas" id="status-belum-lunas">
                                        Belum Lunas <b>(Alt+B)</b>
                                    </label>
                                    <label style="margin-right: 6px;"
                                        title="Pending: Transaksi ini sedang menunggu tindakan atau konfirmasi lebih lanjut. Belum ada keputusan final. (Pintasan: Alt+N)">
                                    ...
                                    <div class="product-list">
                                        @foreach ($data_products as $produkItem)
                                            <div class="product-item" data-id="{{ $produkItem->id }}"
                                                ...
                                                <img src="/upload/products/{{ $produkItem->image }}"
                                                    alt="{{ $produkItem->name }}" />
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-6 mb-3">
                                        <h5 style="color: red; font-size:30px;" class="badge badge-danger"><b>Total
                                                Bayar: </b> </h5> <br>
                                        <h5 style="color: red; font-size:30px;" class="badge badge-danger">Rp. <span
                                                id="total_cost">0</span></h5>
                                        <input type="hidden" name="total_cost" class="form-control total_cost">
                                        <input type="hidden" name="total_cost_before" id="total_cost_before"
                                            class="form-control total_cost_before">
                                        <hr>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="percent_discount"
                                                name="percent_discount" min="0" max="100" value="0">
                                        </div>
                                        <div class="form-group">
                                            <label for="amount_discount">Diskon (Jumlah):</label>
                                            <input type="text" class="form-control" id="amount_discount"
                                                name="amount_discount" value="0">
                                        </div>

                                        <div class="form-group">
                                            <label for="input_payment">Bayar:</label>
                                            <input type="text" class="form-control" id="input_payment"
                                                name="input_payment">
                                        </div>
                                        <div class="form-group">
                                            <label for="return_payment">Kembalian:</label>
                                            <input type="text" class="form-control" id="return_payment"
                                                name="return_payment" readonly>
                                        </div>
                                        ...
                                        <div class="form-group mb-3" id="image_container">
                                            ...
                                            <canvas id="preview_canvas"
                                                style="display: none; max-width: 80%; margin-top: 10px;"></canvas>
                                            <img id="preview_image" src="#" alt="Preview Logo"
                                                style="display: none; max-width: 80%; margin-top: 10px;">
                                ...
                                <div class="border-top">
                                    <div class="card-body">
                                        <button type="submit" class="btn btn-success my-3" style="color:white;"
                                            id="btn-save-order"><i class="fas fa-save"></i> Simpan (F8)</button>
                                        <a href="{{ route('orders.index') }}" class="btn btn-danger"
                                            style="color:white;"><i class="fas fa-step-backward"></i> Kembali</a>
                                    </div>
                                </div>
                            </form>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#customer_id').on('change', function() {
                ...
                var selectedCustomerCategoryId = $('#customer_id option:selected').data(
                                ...
                                if (customerCategoryId) {
                                    $.ajax({
                                        ...
                                        success: function(priceResponse) {
                                            if (priceResponse && priceResponse
                                                .price) {
                                                productPrice = priceResponse
                                                    .price; // Update harga sesuai kategori customer
                                            }
                                            updateCartRow(productId, productName,
                                                productStock, productPrice);
                                            $('#barcode').val(
                                                ''
                                            ); // Kosongkan input barcode setelah berhasil
                                        },
                                        error: function() {
                                            alert(
                                                "Gagal mendapatkan harga berdasarkan kategori customer."
                                            );
                                        }
                                    });
                                } else {
                                    updateCartRow(productId, productName, productStock,
                                        productPrice);
                                    $('#barcode').val(
                                        ''); // Kosongkan input barcode setelah berhasil
                                }
                ...
                if (customerCategoryId) {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            updateCartRow(selectedProductId, selectedProductName,
                                selectedProductStock, selectedProductPrice);
                        },
                        error: function() {
                    ...
                    updateCartRow(selectedProductId, selectedProductName, selectedProductStock,
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            console.log("Response from server:",
                                response); // Debug response dari server

                            if (response && response.price) {
                                selectedProductPrice = response
                                    .price; // Update harga dari server
                            } else {
            ...
            function calculateTotal() {
                ...
                $('#scroll_hor tbody tr').each(function() {
                    ...
                    var hargaBeli = parseInt($(this).find('.cost_price').val().replace(/\./g, '').replace(
                        /[^0-9]/g, '')) || 0;
                ...
                var discountAmount = parseInt($('#amount_discount').val().replace(/\./g, '').replace(/[^0-9]/g,
                    '')) || 0;
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                window.location.href = "{{ url('/orders') }}/" + response
                                    .order_id + "/print-struk";
                            } else {
                    ...
                    error: function(xhr, status, error) {
                        Swal.fire({
                            ...
                            tombolSimpan.prop('disabled', false);
                            iconSimpan.removeClass('fas fa-spinner fa-spin').addClass(
                                'fas fa-save');
                        });
                        console.error(error);
                    }
