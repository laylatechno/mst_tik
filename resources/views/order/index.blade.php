    ...
    <div class="card-body">
        ...
        <div class="card mb-1" id="tutorial-section">
            <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0" style="color: white;">Informasi Halaman Penjualan</h5>
                <!-- Tombol Close -->
            ...
            <div class="card-body">
                <ol>
                    ...
                    <li>
                        Untuk Penjualan yang <b>statusnya Lunas</b> maka tidak bisa diedit dan status selain itu bisa untuk diedit kembali
                    </li>
                    <li>
                        Setiap transaksi yang <b>dihapus/delete</b> maka dia akan mengurangi kembali amount/saldo dari Kas dan menambah kembali stok dari produk terkait
                    </li>
                </ol>
                            ...
                            <div class="row">
                                <div class="col-lg-12 margin-tb">
                                    ...
                                    <div class="pull-right">
                                        <a class="btn btn-success mb-2" href="{{ route('orders.create') }}"><i class="fa fa-plus"></i> Tambah Data</a>
                                    </div>
                                    @endcan
                                </div>
                            </div>
                            ...
                            <table id="scroll_hor" class="table border table-striped table-bordered display nowrap" style="width: 100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/upload/orders/{{ $p->image }}" target="_blank">
                                                <img style="max-width:50px; max-height:50px" src="/upload/orders/{{ $p->image }}" alt="">
                                            </a>
                                        </td>

                                        <td>
                                            <a class="btn btn-warning btn-sm" href="{{ route('orders.show', $p->id) }}">
                                                <i class="fa fa-eye"></i> Show
                                            </a>

                                            @can('order-edit')
                                            @if ($p->status !== 'Lunas')
                                            <a class="btn btn-primary btn-sm" href="{{ route('orders.edit', $p->id) }}">
                                            ...
                                            <form id="delete-form-{{ $p->id }}" method="POST" action="{{ route('orders.destroy', $p->id) }}" style="display:none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                            @endcan
                                            ...
                                            <a class="btn btn-info btn-sm" target="_blank" href="{{ route('orders.print_invoice', $p->id) }}">
                                                <i class="fa fa-file"></i> Print Invoice
                                            </a>

                                            <!-- Tombol Aksi Cetak Invoice -->
                                            <a class="btn btn-danger btn-sm" target="_blank" href="{{ route('orders.print_struk', $p->id) }}">
