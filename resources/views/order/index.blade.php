            ...
            <div class="card mb-1" id="tutorial-section">
                ...
                <div class="card-body">
                    <ol>
                        ...
                        <li>
                            Untuk Penjualan yang <b>statusnya Lunas</b> maka tidak bisa diedit dan status selain itu bisa
                            untuk diedit kembali
                        </li>
                        <li>
                            Setiap transaksi yang <b>dihapus/delete</b> maka dia akan mengurangi kembali amount/saldo dari
                            Kas dan menambah kembali stok dari produk terkait
                        </li>
                    </ol>
                                    ...
                                    <div class="col-lg-12 margin-tb">
                                        @can('order-create')
                                            <div class="pull-right">
                                                <a class="btn btn-success mb-2" href="{{ route('orders.create') }}"><i
