                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item" aria-current="page">
                                    <a class="text-muted text-decoration-none" href="{{ route('products.index') }}">Halaman
                                        Produk</a>
                                </li>
        ...
        <div class="card-body">
            ...
            <div class="card mb-1" id="tutorial-section">
                ...
                <div class="card-body">
                    <ol>
                        <li>
                            Masukkan <b>Nama Produk</b> yang ingin ditambahkan. Pastikan nama produk unik agar tidak
                            membingungkan saat dicari di daftar produk.
                        </li>
                        <li>
                            Pilih <b>Kategori Produk</b> dari dropdown yang tersedia. Kategori digunakan untuk
                            mengelompokkan produk agar lebih mudah dikelola.
                        </li>
                        <li>
                            Masukkan <b>Kode Produk</b> dengan karakter bebas, sedangkan untuk <b>Barcode</b> sifatnya
                            opsional, karena bisa diisi ketika proses generate barcode
                        </li>
                        <li>
                            Masukkan <b>Harga Produk</b> dalam bentuk angka tanpa simbol mata uang (contoh: 50000). Pastikan
                            harga sesuai dengan kebijakan penjualan.
                        </li>
                        <li>
                            Jika produk memiliki <b>harga yang bervariasi</b> sesuai dengan jenis/kategori
                            konsumen/pelanggan, maka bisa diatur pada tab <b>Harga Lain</b>
                        </li>
                        <li>
                            Tentukan <b>Jumlah Stok</b> awal produk. Masukkan angka yang mencerminkan jumlah barang yang
                            tersedia saat ini. Namun jika misal belum ada silahkan berikan nilai default 0
                        </li>
                        <li>
                            Upload <b>Gambar Produk</b> dengan format yang didukung (JPEG/PNG). Gambar ini akan membantu
                            pelanggan mengenali produk.
                        </li>
                        <li>
                            Isi <b>Deskripsi Produk</b> untuk memberikan informasi tambahan seperti fitur atau keunggulan
                            produk.
                        </li>
                        <li>
                            Setelah semua informasi lengkap, klik tombol <b>Simpan</b> untuk menambahkan produk ke dalam
                            database. Pastikan semua data sudah benar sebelum menyimpan.
                        </li>
                    </ol>
                    <p class="text-muted">
                        Pastikan semua informasi telah diisi dengan benar sebelum menyimpan data. Jika ada kesalahan, Anda
                        dapat mengedit kembali atau membatalkan dengan menekan tombol <b>Kembali</b>.
                    </p>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs" id="formTabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="harga-tab" data-bs-toggle="tab" href="#harga" role="tab"
                                        aria-controls="harga" aria-selected="false">Harga Lain</a>
                                </li>
                            </ul>

                            <!-- Tab Content -->
                            <form method="POST" action="{{ route('products.update', $data_product->id) }}"
                                ...
                                <div class="tab-content mt-3" id="formTabsContent">
                                    ...
                                    <div class="tab-pane fade show active" id="general" role="tabpanel"
                                                ...
                                                <select name="user_id" id="user_id" class="form-control select2" required>
                                                    ...
                                                    @foreach ($users as $user)
                                                        <option value="{{ $user->id }}"
                                                            {{ $data_product->user_id == $user->id ? 'selected' : '' }}>
                                                            {{ $user->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control" id="name"
                                                value="{{ old('name', $data_product->name) }}" required>
                                            <input type="hidden" name="slug" class="form-control" id="slug"
                                                value="{{ old('slug', $data_product->slug) }}" required readonly>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" name="code_product" class="form-control"
                                                        id="code_product"
                                                        value="{{ old('code_product', $data_product->code_product) }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" name="barcode" class="form-control"
                                                        id="barcode"
                                                        value="{{ old('barcode', $data_product->barcode) }}">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <select id="category_id" name="category_id" class="form-control" required>
                                                ...
                                                @foreach ($data_categories as $category)
                                                    <option value="{{ $category->id }}"
                                                        {{ old('category_id', $data_product->category_id) == $category->id ? 'selected' : '' }}>
                                            ...
                                            <select id="unit_id" name="unit_id" class="form-control" required>
                                                ...
                                                @foreach ($data_units as $unit)
                                                    <option value="{{ $unit->id }}"
                                                        {{ old('unit_id', $data_product->unit_id) == $unit->id ? 'selected' : '' }}>
                                                        {{ $unit->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-6 mb-3">
                                                ...
                                                <input type="text" name="purchase_price" class="form-control"
                                                    id="purchase_price"
                                                    value="{{ old('purchase_price', $data_product->purchase_price) }}"
                                            ...
                                            <div class="form-group col-6 mb-3">
                                                ...
                                                <input type="text" name="cost_price" class="form-control"
                                                    id="cost_price"
                                                    value="{{ old('cost_price', $data_product->cost_price) }}"
                                        ...
                                        <div class="row">
                                            <div class="form-group col-6 mb-3">
                                                ...
                                                <input type="number" name="stock" class="form-control" id="stock"
                                                    value="{{ old('stock', $data_product->stock) }}">
                                            </div>
                                            <div class="form-group col-6 mb-3">
                                                <label for="reminder">Reminder Stok Minimum</label>
                                                <input type="number" name="reminder" class="form-control"
                                                    id="reminder"
                                                    value="{{ old('reminder', $data_product->reminder) }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control" name="note" id="note">{{ old('note', $data_product->note) }}</textarea>
                                        </div>


                                        <div class="form-group col-6 mb-3">
                                            <label
                                                title="Status Aktif berpengaruh terhadap tampilnya produk pada Penjualan/menu Kasir/POS">
                                                Status Aktif <i class="fa fa-info-circle"></i>
                                            </label>
                                            <div>
                                                <label class="me-3">
                                                    <input type="radio" name="status_active" value="active" required
                                                        {{ old('status_active', $data_product->status_active ?? '') == 'active' ? 'checked' : '' }}>
                                                    Active
                                                </label>
                                                <label>
                                                    <input type="radio" name="status_active" value="nonactive" required
                                                        {{ old('status_active', $data_product->status_active ?? '') == 'nonactive' ? 'checked' : '' }}>
                                                    Non Active
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-6 mb-3">
                                            <label
                                                title="Status Display berpengaruh terhadap tampilnya produk pada Halaman Depan yang diakses oleh pengguna umum">
                                                Status Display <i class="fa fa-info-circle"></i>
                                            </label>
                                            <div>
                                                <label class="me-3">
                                                    <input type="radio" name="status_display" value="active" required
                                                        {{ old('status_display', $data_product->status_display ?? '') == 'active' ? 'checked' : '' }}>
                                                    Active
                                                </label>
                                                <label>
                                                    <input type="radio" name="status_display" value="nonactive"
                                                        required
                                                        {{ old('status_display', $data_product->status_display ?? '') == 'nonactive' ? 'checked' : '' }}>
                                                    Non Active
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-6 mb-3">
                                            <label
                                                title="Status Diskon berpengaruh terhadap harga coret yg biasa muncul pada Halaman Depan yang diakses oleh pengguna umum">
                                                Status Diskon <i class="fa fa-info-circle"></i>
                                            </label>
                                            <div>
                                                <label class="me-3">
                                                    <input type="radio" name="status_discount" value="active" required
                                                        {{ old('status_discount', $data_product->status_discount ?? '') == 'active' ? 'checked' : '' }}
                                                        onclick="toggleDiscount()"> Active
                                                </label>
                                                <label>
                                                    <input type="radio" name="status_discount" value="nonactive"
                                                        required
                                                        {{ old('status_discount', $data_product->status_discount ?? '') == 'nonactive' ? 'checked' : '' }}
                                                        onclick="toggleDiscount()"> Non Active
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" id="discount_section" style="display: none;">
                                            <div class="form-group col-12 mb-3">
                                                ...
                                                <input type="number" name="price_before_discount" class="form-control"
                                                    ...
                                                    value="{{ old('price_before_discount', $data_product->price_before_discount ?? 0) }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            @if ($data_product->image)
                                                <img id="preview_image"
                                                    src="{{ asset('upload/products/' . $data_product->image) }}"
                                                    alt="Preview Logo"
                                                    style="display: block; max-width: 20%; margin-top: 10px;">
                                            @else
                                            ...
                                            <canvas id="preview_canvas"
                                                style="display: none; max-width: 50%; margin-top: 10px;"></canvas>
                                    ...
                                    <div class="tab-pane fade" id="harga" role="tabpanel"
                                        ...
                                        <div id="customer-prices-container">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-5">
                                                                ...
                                                                <select name="customer_category_id[]"
                                                                    ...
                                                                    <option value="" disabled selected>-- Pilih
                                                                        Kategori Konsumen --</option>
                                                                    @foreach ($data_customer_categories as $p)
                                                                        <option value="{{ $p->id }}"
                                                                            {{ $price->customer_category_id == $p->id ? 'selected' : '' }}>
                                                                            {{ $p->name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                            ...
                                                            <div class="col-md-5">
                                                                ...
                                                                <input type="text" name="customer_price[]"
                                                                    class="form-control"
                                                                    value="{{ old('customer_price.' . $index, $price->price) }}"
                                            ...
                                            <button type="button" id="add-customer-price"
                                                class="btn btn-success btn-sm mt-3"><i class="fa fa-plus"></i>
                                                Tambah</button>
                                        </div>
                                    </div>
