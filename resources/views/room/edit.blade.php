                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a class="text-muted text-decoration-none"
                                        href="/">Beranda</a></li>
                                <li class="breadcrumb-item"><a class="text-muted text-decoration-none"
                                        href="{{ route('rooms.index') }}">Halaman Kategori Produk</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <form method="POST" action="{{ route('rooms.update', $data_rooms->id) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control" id="name"
                                                value="{{ old('name', $data_rooms->name) }}" required>
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="code" class="form-control" id="code"
                                                value="{{ old('code', $data_rooms->code) }}">
                                        </div>

                                        <!-- Deskripsi -->
                                        <div class="form-group mb-3">
                                            <label for="description">Deskripsi</label>
                                            <textarea class="form-control" name="description" id="description">{{ old('description', $data_rooms->description) }}</textarea>
                                        </div>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <a class="btn btn-warning btn-sm mb-3" href="{{ route('rooms.index') }}"><i
