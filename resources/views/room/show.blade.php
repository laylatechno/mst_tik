                            ...
                            <div class="table-responsive">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-item">
                                        ...
                                        <br>
                                        @if ($data_rooms->image)
                                        <img src="{{ asset('upload/rooms/' . $data_rooms->image) }}" alt="Blog Image" class="img-thumbnail" style="max-width: 200px;">
                                        @else
                                ...
                                <a class="btn btn-warning mb-2 mt-3" href="{{ route('rooms.index') }}"><i
